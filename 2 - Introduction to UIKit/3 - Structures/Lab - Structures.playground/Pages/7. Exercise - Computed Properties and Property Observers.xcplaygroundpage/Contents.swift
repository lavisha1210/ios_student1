...
var answer=Rectangle(width: 3, height: 2)
print(answer.area)
...
var personHeight=Height(heightInInches: 68.0)
print(personHeight.heightInCentimeters)
var personheight1=Height(heightInCentimeters: 172.72)
print(personheight1.heightInInches)
