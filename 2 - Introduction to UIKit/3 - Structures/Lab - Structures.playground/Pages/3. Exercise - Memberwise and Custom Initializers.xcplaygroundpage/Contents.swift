...
var someplace=GPS(latitude: 51.514004, logitude: 0.125226)
print(someplace)
...
var favouriteBook=Book(title: "Harry", author: "Roy", pages: 50, price:100.0)
print(favouriteBook)
/*:
 ...
 */
struct Laptop{
    var screeSize:Int=13
    var repairCount:Int=0
    var yearPurchased:Int
}

var one=Laptop(yearPurchased: 2002)
var two=Laptop(yearPurchased: 2003)
var three=Laptop(screeSize: 2,repairCount:3,yearPurchased: 2004)
...
var myHeight=Height(heightInCentimeters: 151.6)
print(myHeight)
